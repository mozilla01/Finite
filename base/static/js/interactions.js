...
const showTransactionDetails = async (
    ...
    if (source) {
        ...
        document.getElementById("transacSource").classList.remove("hidden");
        document.getElementById("transacCategory").classList.add("hidden");
    } else {
        document.getElementById("transacCategory").value = category;
        document.getElementById("transacCategory").classList.remove("hidden");
        document.getElementById("transacSource").classList.add("hidden");
    }
...
document
    ...
    .addEventListener("submit", async (e) => {
        ...
        const category = document.getElementById("transacCategory").value;
