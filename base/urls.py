...
urlpatterns = [
    ...
    path('update-transaction/<str:pk>', views.UpdateTransaction.as_view(), name='update-transaction'),
    ...
    path('render-graphs', views.RenderGraphs.as_view(), name='render-graphs'),
